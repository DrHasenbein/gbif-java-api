...
public class TestParser {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Species spec = new Species(SpeciesParser.searchSpecies("Bellis"));
			...
			//Vernacular Names
			System.out.println("---------------Vernacular Names_1:--------------------");
			HashMap<String, String> names = spec.getVernacularNames();
		  ...
		  //Vernacular Names
			System.out.println("---------------Vernacular Names_2:--------------------");
			HashMap<String, String> names2 = spec2.getVernacularNames();
			// Get a set of the entries
		    Set<Entry<String, String>> set2 = names2.entrySet();
		    // Get an iterator
		    Iterator<Entry<String, String>> i2 = set2.iterator();
		    // Display elements
		    while(i2.hasNext()) {
		       Entry<String, String> me = i2.next();
		       System.out.print(me.getKey() + ": ");
		       System.out.println(me.getValue());
		    }
